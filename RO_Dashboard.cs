...
{
    public partial class RO_Dashboard : MetroFramework.Forms.MetroForm
    {
        public RO_Dashboard(string sm,string nm)
        {
            InitializeComponent();
            SM = sm;
            NM = nm;
        ...
        private void RO_Dashboard_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        {
            this.Hide();
            RO_Print_Bill pb = new RO_Print_Bill(SM,NM);
            pb.Show();
        }
    }
}
